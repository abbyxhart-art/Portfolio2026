import svgPaths from "./svg-ltxpfwje1r";
type CursorProps = {
  className?: string;
...
export default function Cursor1() {
  return <Cursor className="bg-[rgba(35,34,38,0.2)] relative rounded-[18.667px] size-full" instance="Internal Page Hover" type="Click" />;
}