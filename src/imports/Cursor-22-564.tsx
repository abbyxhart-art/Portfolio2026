import svgPaths from "./svg-y3di1ss1xj";
type CursorProps = {
  className?: string;
...
export default function Cursor1() {
  return <Cursor className="bg-[rgba(35,34,38,0.1)] overflow-clip relative rounded-[18.667px] size-full" instance="Internal Page Hover" />;
}