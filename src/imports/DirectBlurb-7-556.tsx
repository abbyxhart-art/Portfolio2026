import svgPaths from "./svg-c400htpy3t";
  ...
  return (
    <div className="bg-[rgba(247,246,251,0.8)] content-stretch flex gap-[24px] items-start pl-[42px] pr-[25px] py-[24px] relative rounded-[100px] size-full" data-name="Direct Blurb">
      ...
      <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[404px]" data-name="Text">
        <div className="content-stretch flex flex-col font-['Inter_Tight:Regular',sans-serif] font-normal gap-[2px] items-start leading-[1.5] relative shrink-0 text-[18px] w-full" data-name="Work">
          <p className="opacity-78 relative shrink-0 text-[#232226] w-full">Looking for work Summer 2026 / Full Time</p>
          <p className="opacity-78 relative shrink-0 text-[#716c87] w-full">Keeping things human with taste and intention</p>
        </div>
