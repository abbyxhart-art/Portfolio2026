import svgPaths from "./svg-x9qi7viegj";
    ...
    <div className="bg-[rgba(247,246,251,0.8)] content-stretch flex gap-[24px] items-start px-[42px] py-[24px] relative rounded-[100px] size-full" data-name="Direct Blurb">
      ...
      <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0" data-name="Text">
        <div className="content-stretch flex flex-col font-['Inter_Tight:Regular',sans-serif] font-normal gap-[2px] items-start leading-[1.5] relative shrink-0 text-[18px] w-full whitespace-nowrap" data-name="Work">
          ...
          <p className="opacity-78 relative shrink-0 text-[#7E7C87]">Keeping things human with taste and intention</p>
        </div>
        <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Button">
          ...
          <div className="backdrop-blur-[2.5px] bg-[#e8e7f0] content-stretch flex flex-col items-start px-[16px] py-[6px] relative rounded-[100px] shrink-0" data-name="casestudy-tag-2">
            ...
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.2] not-italic relative shrink-0 text-[#7E7C87] text-[16px] whitespace-nowrap">Let's connect</p>
          </div>
        </div>
      </div>
    </div>
