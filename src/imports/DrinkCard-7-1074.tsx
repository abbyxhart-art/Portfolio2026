import svgPaths from "./svg-h2w4ohvg0i";
      ...
      <div className="content-stretch flex gap-[36px] items-center relative shrink-0 w-full" data-name="Boba Frame">
        ...
        <div className="content-stretch flex flex-col gap-[14px] items-center relative shrink-0 w-[86px]" data-name="Matcha Cream">
          <div className="h-[62px] relative shrink-0 w-[42px]" data-name="Illustration Matcha Cream">
            ...
            <div className="absolute bg-[rgba(94,135,90,0.7)] h-[44px] left-[3px] opacity-0 rounded-bl-[24px] rounded-br-[24px] top-[18px] w-[37px]" data-name="Matcha" />
            <div className="absolute bg-[rgba(255,255,255,0.7)] h-[17px] left-[3px] opacity-0 rounded-bl-[24px] rounded-br-[24px] top-[45px] w-[37px]" data-name="Matcha" />
        ...
        <div className="content-stretch flex flex-col gap-[14px] items-center relative shrink-0 w-[74px]" data-name="Lychee Rose">
          <div className="h-[62px] relative shrink-0 w-[42px]" data-name="Illustration Lychee Rose">
            ...
            <div className="absolute bg-[#fb21f3] left-[10px] opacity-0 size-[4px] top-[34px]" data-name="Boba" />
            <Wrapper>
              <div className="bg-[#fb21f3] opacity-0 size-[4px]" data-name="Boba" />
            </Wrapper>
            <div className="absolute bg-[#fb21f3] left-[33px] opacity-0 size-[4px] top-[38px]" data-name="Boba" />
            <div className="absolute bg-[#fb21f3] left-[33px] opacity-0 size-[4px] top-[46px]" data-name="Boba" />
            <div className="absolute bg-[#fb21f3] left-[27px] opacity-0 size-[4px] top-[42px]" data-name="Boba" />
            <div className="absolute bg-[#fb21f3] left-[27px] opacity-0 size-[4px] top-[50px]" data-name="Boba" />
            <div className="absolute bg-[#fb21f3] left-[10px] opacity-0 size-[4px] top-[50px]" data-name="Boba" />
            <div className="absolute bg-[rgba(193,111,255,0.45)] h-[44px] left-[3px] opacity-0 rounded-bl-[24px] rounded-br-[24px] top-[18px] w-[37px]" data-name="Lychee" />
            <div className="absolute border-[#302f33] border-[0.75px] border-solid h-[53px] left-[3px] rounded-bl-[24px] rounded-br-[24px] top-[9px] w-[37px]" data-name="Cup" />
            <div className="absolute bg-[#302f33] h-[4px] left-0 rounded-[10px] top-[6px] w-[42px]" data-name="Lid" />
          </div>
          <p className="font-['Inter_Tight:Regular',sans-serif] font-normal leading-[1.2] relative shrink-0 text-[#a29db6] text-[14px] tracking-[-0.28px] whitespace-nowrap">?</p>
        ...
        <div className="content-stretch flex flex-col gap-[14px] items-center relative shrink-0 w-[82px]" data-name="Black Sesame">
          <div className="h-[62px] relative shrink-0 w-[42px]" data-name="Illustration Black Sesame">
            <div className="absolute bg-[#302f33] h-[53px] left-[20px] top-0 w-[4px]" data-name="Straw" />
            <div className="absolute bg-black left-[6px] opacity-0 rounded-[10px] size-[4px] top-[42px]" data-name="Boba" />
            <div className="absolute bg-black left-[14px] opacity-0 rounded-[10px] size-[4px] top-[42px]" data-name="Boba" />
            <div className="absolute bg-black left-[10px] opacity-0 rounded-[10px] size-[4px] top-[34px]" data-name="Boba" />
            <Wrapper>
              <div className="bg-black opacity-0 rounded-[10px] size-[4px]" data-name="Boba" />
            </Wrapper>
            <div className="absolute bg-black left-[33px] opacity-0 rounded-[10px] size-[4px] top-[38px]" data-name="Boba" />
            <div className="absolute bg-black left-[33px] opacity-0 rounded-[10px] size-[4px] top-[46px]" data-name="Boba" />
            <div className="absolute bg-black left-[27px] opacity-0 rounded-[10px] size-[4px] top-[42px]" data-name="Boba" />
            <div className="absolute bg-black left-[27px] opacity-0 rounded-[10px] size-[4px] top-[50px]" data-name="Boba" />
            <div className="absolute bg-black left-[10px] opacity-0 rounded-[10px] size-[4px] top-[50px]" data-name="Boba" />
            <div className="absolute bg-[rgba(113,108,135,0.2)] h-[20px] left-[3px] opacity-0 rounded-bl-[24px] rounded-br-[24px] top-[42px] w-[37px]" data-name="Black Sesame" />
            <div className="absolute bg-[rgba(113,108,135,0.2)] h-[28px] left-[3px] opacity-0 rounded-bl-[24px] rounded-br-[24px] top-[34px] w-[37px]" data-name="Black Sesame" />
            <div className="absolute bg-[rgba(113,108,135,0.2)] h-[36px] left-[3px] opacity-0 rounded-bl-[24px] rounded-br-[24px] top-[26px] w-[37px]" data-name="Black Sesame" />
            <div className="absolute bg-[rgba(113,108,135,0.2)] h-[44px] left-[3px] opacity-0 rounded-bl-[24px] rounded-br-[24px] top-[18px] w-[37px]" data-name="Black Sesame" />
            <div className="absolute border-[#302f33] border-[0.75px] border-solid h-[53px] left-[3px] rounded-bl-[24px] rounded-br-[24px] top-[9px] w-[37px]" data-name="Cup" />
            <div className="absolute bg-[#302f33] h-[4px] left-0 rounded-[10px] top-[6px] w-[42px]" data-name="Lid" />
          </div>
          <p className="font-['Inter_Tight:Regular',sans-serif] font-normal leading-[1.2] relative shrink-0 text-[#a29db6] text-[14px] tracking-[-0.28px] whitespace-nowrap">?</p>
