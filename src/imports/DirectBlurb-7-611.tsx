import svgPaths from "./svg-ot13tc5e21";

export default function DirectBlurb() {
  return (
    <div className="bg-[rgba(247,246,251,0.8)] content-stretch flex gap-[24px] items-start px-[42px] py-[24px] relative rounded-[100px] size-full" data-name="Direct Blurb">
      <div aria-hidden="true" className="absolute border border-[#c8c4d7] border-solid inset-0 pointer-events-none rounded-[100px] shadow-[0px_4px_20px_0px_rgba(154,71,255,0.2)]" />
      ...
      <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0" data-name="Text">
        <div className="content-stretch flex flex-col font-['Inter_Tight:Regular',sans-serif] font-normal gap-[2px] items-start leading-[1.5] relative shrink-0 text-[18px] w-full whitespace-nowrap" data-name="Work">
          <p className="opacity-78 relative shrink-0 text-[#232226]">Looking for work Summer 2026 / Full Time</p>
          <p className="opacity-78 relative shrink-0 text-[#716c87]">Keeping things human with taste and intention</p>
        </div>
        <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Button">
          <div className="backdrop-blur-[2.5px] bg-[#ecdcff] content-stretch flex flex-col items-start px-[12px] py-[6px] relative rounded-[24px] shrink-0" data-name="casestudy-tag-2">
            ...
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.2] not-italic relative shrink-0 text-[#9a47ff] text-[16px] whitespace-nowrap">Send an email</p>
          </div>
          <div className="backdrop-blur-[2.5px] bg-[#e8e7f0] content-stretch flex flex-col items-start px-[16px] py-[6px] relative rounded-[100px] shrink-0" data-name="casestudy-tag-2">
            ...
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.2] not-italic relative shrink-0 text-[#716c87] text-[16px] whitespace-nowrap">Let’s connect</p>
          </div>
        </div>
      </div>
    </div>
