import svgPaths from "./svg-0dlnp5tare";
type CursorProps = {
  className?: string;
...
export default function Cursor1() {
  return <Cursor className="bg-[rgba(154,71,255,0.3)] relative rounded-[18.667px] size-full" instance="External Links" type="Cllick" />;
}