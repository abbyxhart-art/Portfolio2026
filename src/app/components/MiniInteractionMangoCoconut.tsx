...
export default function MiniInteractionMangoCoconut() {
  ...
  return (
    ...
    >
      ...
      {/* Label */}
      <p
        className={`font-['Inter_Tight',sans-serif] leading-[1.2] not-italic text-[14px] text-center tracking-[-0.28px] w-[42px] transition-colors duration-150 ${
          hovered
            ? "text-[color:var(--text\/primary,#232226)]"
            : "text-[color:var(--text\/quatrinary,#aeabb9)]"
        }`}
      >
        {isEmpty ? "Refill" : "Sip"}
      </p>
