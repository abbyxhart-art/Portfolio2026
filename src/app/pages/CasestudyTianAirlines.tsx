      ...
      >
        <div className="flex flex-col items-center w-full">
          ...
          <motion.div style={{ y: contentY }} className="flex flex-col gap-[8vh] items-center w-full pt-[8px]">
            ...
            <p className="font-['Inter_Tight',sans-serif] font-normal leading-[1.2] text-[#908e99] text-[12px] md:text-[14px] w-full">
              Prototype Full Flow
            </p>
            ...
            <div id="cs-overview" className="flex flex-col gap-[32px] items-start w-full">
              <div className="border-b border-[#302f34] flex flex-col gap-[8px] items-start pb-[32px] w-full">
                ...
                <div className="font-['Inter_Tight',sans-serif] font-normal leading-[1.25] text-[#908e99] text-[16px] md:text-[20px] w-full">
              ...
              <div className="flex gap-[57px] items-start w-full">
                ...
                <div className="flex flex-col gap-[32px] items-start shrink-0 font-['Inter_Tight',sans-serif] text-[14px] md:text-[16px]">
                ...
                <div className="flex flex-1 flex-col gap-[32px] items-start min-w-0">
                  <div className="flex flex-col gap-[12px] items-start font-['Inter_Tight',sans-serif] text-[14px] md:text-[16px]">
                  ...
                  <div className="flex flex-col gap-[12px] items-start w-full">
                    <p className="font-['Inter_Tight',sans-serif] leading-none text-[#908e99] text-[14px] md:text-[16px]">Notes</p>
                    <div className="font-['Inter_Tight',sans-serif] font-normal leading-[1.65] text-[color:var(--text\/primary,#eeedf5)] text-[14px] md:text-[16px] w-full">
            ...
            <div id="cs-design-system" className="flex flex-col gap-[8vh] items-start w-full scroll-mt-[100px]">
              ...
              <div className="flex flex-col gap-[32px] items-start w-full">
                <div className="flex flex-col gap-[16px] items-start w-full">
                  ...
                  >
                    <span className="font-['Inter_Tight',sans-serif] font-[300] leading-none text-[#faf9ff] text-[12px] md:text-[14px]">View Design System</span>
                  </button>
                </div>
            ...
            <div className="flex flex-col gap-[8vh] items-start w-full">
              ...
              <div className="flex gap-[24px] items-stretch w-full">
                ...
                <div className="flex flex-col justify-between gap-[32px] flex-1 min-w-0">
                  <div className="flex flex-col gap-[16px] items-start w-full">
                    <p className="font-['Inter_Tight',sans-serif] leading-none text-[#908e99] text-[14px] md:text-[16px] w-full">Figma Variables</p>
                    <p className="font-['Inter_Tight',sans-serif] font-[450] leading-[1.3] text-[color:var(--text\/primary,#eeedf5)] text-[18px] md:text-[24px] w-full">Tons of tokens and styles</p>
                    <p className="font-['Inter_Tight',sans-serif] font-normal leading-[1.65] text-[color:var(--text\/tertiary,#7e7c87)] text-[14px] md:text-[17px] w-full">
                  ...
                  <div className="flex flex-col gap-[16px] items-start w-full">
                    ...
                    <p className="font-['Inter_Tight',sans-serif] font-normal leading-none text-[#908e99] text-[12px] md:text-[14px] w-full">Variable Scope, Tokens, and Color, oh my!</p>
                  </div>
                </div>
                {/* Right: Components and Prototyping */}
                <div className="flex flex-col justify-between gap-[32px] flex-1 min-w-0">
                  <div className="flex flex-col gap-[16px] items-start w-full">
                    <p className="font-['Inter_Tight',sans-serif] leading-none text-[#908e99] text-[14px] md:text-[16px] w-full">Components and Prototyping</p>
                    <p className="font-['Inter_Tight',sans-serif] font-[450] leading-[1.3] text-[color:var(--text\/primary,#eeedf5)] text-[18px] md:text-[24px] w-full">Figma calculators + if/else</p>
                    <div className="font-['Inter_Tight',sans-serif] font-normal leading-[1.65] text-[color:var(--text\/tertiary,#7e7c87)] text-[14px] md:text-[17px] w-full">
                  ...
                  <div className="flex flex-col gap-[16px] items-start w-full">
                    ...
                    <p className="font-['Inter_Tight',sans-serif] font-normal leading-none text-[#908e99] text-[12px] md:text-[14px] w-full">{`The calendar logic was the hardest but most rewarding!`}</p>
                  </div>
                </div>
              </div>
              ...
              <div id="cs-flight-planning" className="flex flex-col gap-[8vh] items-start w-full scroll-mt-[100px]">
                ...
                <div className="flex flex-col gap-[24px] items-start w-full">
                  ...
                  <div className="border border-[#302f34] flex flex-col gap-[16px] items-start overflow-clip p-[24px] rounded-[8px] w-full" style={{ background: "rgba(88,85,100,0.15)" }}>
                    <div className="flex flex-col gap-[16px] items-start w-full">
                      <p className="font-['Inter_Tight',sans-serif] font-[300] leading-none text-[#585564] text-[14px] md:text-[16px]">Hey ChatGPT...</p>
                      <p className="font-['Inter_Tight',sans-serif] leading-[1.4] text-[#faf9ff] text-[16px] md:text-[20px] w-full whitespace-pre-wrap">
                    ...
                    <p className="font-['Inter_Tight',sans-serif] font-[300] leading-[1.5] text-[#908e99] text-[12px] md:text-[14px] w-full">
                ...
                <div className="flex flex-col gap-[16px] w-full">
                  ...
                  <p className="font-['Inter_Tight',sans-serif] font-normal leading-none text-[#908e99] text-[12px] md:text-[14px]">Military timeline view for component development</p>
                </div>
                <div className="flex gap-[24px] items-start w-full">
                  <div className="flex flex-col gap-[16px] flex-1 min-w-0">
                    ...
                    <p className="font-['Inter_Tight',sans-serif] font-normal leading-none text-[#908e99] text-[12px] md:text-[14px]">Unique flight codes and tags</p>
                  </div>
                  <div className="flex flex-col gap-[16px] flex-1 min-w-0">
                    <div className="aspect-[2/1] bg-[#eeedf5] rounded-[8px] w-full overflow-hidden">
                      <img src={imgFlightPaths} alt="Tian Flight Paths" className="w-full h-full object-cover" />
                    </div>
                    <p className="font-['Inter_Tight',sans-serif] font-normal leading-none text-[#908e99] text-[12px] md:text-[14px]">Flight direction for peers to understand</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div id="cs-final-designs" className="flex flex-col gap-[8vh] items-start w-full scroll-mt-[100px]">
              ...
              <div className="border border-[#302f34] flex flex-col gap-[75px] items-start p-[24px] rounded-[8px] w-full" style={{ background: "linear-gradient(to bottom, #302f34 0%, #161617 65%)" }}>
                ...
                <div className="flex flex-col gap-[24px] items-start w-full">
                  <div className="flex flex-col gap-[16px] items-start w-full">
                    <p className="font-['Inter_Tight',sans-serif] font-[300] leading-none text-[#908e99] text-[14px] md:text-[16px]">Flow 1/5</p>
                    <p className="font-['Inter_Tight',sans-serif] leading-[1.3] text-[#faf9ff] text-[18px] md:text-[24px]">Too many choices → Progressive flow</p>
                  </div>
                ...
                <div className="flex flex-col gap-[24px] items-start w-full">
                  <div className="flex flex-col gap-[16px] items-start w-full">
                    <p className="font-['Inter_Tight',sans-serif] font-[300] leading-none text-[#908e99] text-[14px] md:text-[16px]">Flow 2/5</p>
                    <p className="font-['Inter_Tight',sans-serif] leading-[1.3] text-[#faf9ff] text-[18px] md:text-[24px]">Calendar + booking process</p>
                    <p className="font-['Inter_Tight',sans-serif] font-[300] leading-[1.65] text-[#908e99] text-[14px] md:text-[17px] w-full">
                ...
                <div className="flex flex-col gap-[24px] items-start w-full">
                  <div className="flex flex-col gap-[16px] items-start w-full">
                    <p className="font-['Inter_Tight',sans-serif] font-[300] leading-none text-[#908e99] text-[14px] md:text-[16px]">Flow 3/5</p>
                    <p className="font-['Inter_Tight',sans-serif] leading-[1.3] text-[#faf9ff] text-[18px] md:text-[24px]">Tickets</p>
                    <p className="font-['Inter_Tight',sans-serif] font-[300] leading-[1.65] text-[#b8b4c5] text-[14px] md:text-[16px] tracking-[-0.32px] w-full">
                ...
                <div className="flex flex-col gap-[24px] items-start w-full">
                  <div className="flex flex-col gap-[16px] items-start w-full">
                    <p className="font-['Inter_Tight',sans-serif] font-[300] leading-none text-[#908e99] text-[14px] md:text-[16px]">Flow 4/5</p>
                    <p className="font-['Inter_Tight',sans-serif] leading-[1.3] text-[#faf9ff] text-[18px] md:text-[24px]">Passenger Forms</p>
                    <p className="font-['Inter_Tight',sans-serif] font-[300] leading-[1.65] text-[#b8b4c5] text-[14px] md:text-[16px] tracking-[-0.32px] w-full">
                ...
                <div className="flex flex-col gap-[24px] items-start w-full">
                  <div className="flex flex-col gap-[16px] items-start w-full">
                    <p className="font-['Inter_Tight',sans-serif] font-[300] leading-none text-[#908e99] text-[14px] md:text-[16px]">Flow 5/5</p>
                    <p className="font-['Inter_Tight',sans-serif] leading-[1.3] text-[#faf9ff] text-[18px] md:text-[24px]">End flow</p>
                    <p className="font-['Inter_Tight',sans-serif] font-[300] leading-[1.65] text-[#b8b4c5] text-[14px] md:text-[16px] tracking-[-0.32px] w-full">
              ...
              <div className="flex flex-col gap-[24px] items-start w-full">
                <div className="flex flex-col gap-[16px] items-start">
                  <p className="font-['Inter_Tight',sans-serif] font-[300] leading-none text-[#908e99] text-[14px] md:text-[16px]">Closing thoughts</p>
                  <p className="font-['Inter_Tight',sans-serif] leading-[1.3] text-[#faf9ff] text-[18px] md:text-[24px]">A methodical practice</p>
                </div>
                ...
                <div className="border border-[#302f34] flex gap-[16px] items-start p-[16px] rounded-[8px] w-full" style={{ background: "rgba(219,189,254,0.05)" }}>
                  <p className="font-['Inter_Tight',sans-serif] font-[300] leading-[2.05] text-[#908e99] text-[12px] md:text-[14px] shrink-0">1</p>
                  <div className="flex flex-1 flex-col gap-[8px] items-start leading-[1.65] min-w-0">
                    <p className="font-['Inter_Tight',sans-serif] text-[#faf9ff] text-[14px] md:text-[17px] whitespace-nowrap">If/Else calculators</p>
                    <p className="font-['Inter_Tight',sans-serif] font-[300] text-[#b8b4c5] text-[14px] md:text-[16px] tracking-[-0.32px] w-full">{`Creating this system required a mix of code informed thinking and design. It's powered by Figma calculators and layered conditional logic. Bringing this level of complexity to life is so exciting!`}</p>
                  </div>
                </div>

                {/* Card 2 */}
                <div className="border border-[#302f34] flex gap-[16px] items-start p-[16px] rounded-[8px] w-full" style={{ background: "rgba(219,189,254,0.05)" }}>
                  <p className="font-['Inter_Tight',sans-serif] font-[300] leading-[2.05] text-[#908e99] text-[12px] md:text-[14px] shrink-0">2</p>
                  <div className="flex flex-1 flex-col gap-[8px] items-start leading-[1.65] min-w-0">
                    <p className="font-['Inter_Tight',sans-serif] text-[#faf9ff] text-[14px] md:text-[17px] whitespace-nowrap">Benchmarking with peers</p>
                    <p className="font-['Inter_Tight',sans-serif] font-[300] text-[#b8b4c5] text-[14px] md:text-[16px] tracking-[-0.32px] w-full">{`While this isn't a product that will be used by an airline, I really enjoyed the practice of deep design thinking. For benchmarking, we tested amongst peers and I was able to find the gaps in the design system.`}</p>
                  </div>
                </div>

                {/* Card 3 */}
                <div className="border border-[#302f34] flex gap-[16px] items-start p-[16px] rounded-[8px] w-full" style={{ background: "rgba(219,189,254,0.05)" }}>
                  <p className="font-['Inter_Tight',sans-serif] font-[300] leading-[2.05] text-[#908e99] text-[12px] md:text-[14px] shrink-0">3</p>
                  <div className="flex flex-1 flex-col gap-[8px] items-start leading-[1.65] min-w-0">
                    <p className="font-['Inter_Tight',sans-serif] text-[#faf9ff] text-[14px] md:text-[17px] whitespace-nowrap">Brad Frost..</p>
                    <p className="font-['Inter_Tight',sans-serif] font-[300] text-[#b8b4c5] text-[14px] md:text-[16px] tracking-[-0.32px] w-full">Atomic Design is a powerful mental model, and something we learn at RIT to better create scalable systems.</p>
                    ...
                    >
                      <span className="font-['Inter_Tight',sans-serif] font-[300] leading-none text-[#faf9ff] text-[12px] md:text-[14px]">Checkout my presentation of Brad Frost</span>
                    </button>
                  </div>
                </div>
              </div>
