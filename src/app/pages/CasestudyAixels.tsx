...
import { motion, AnimatePresence, useScroll, useTransform, useMotionValue, useInView, useAnimationControls } from "motion/react";
  ...
  return (
    <div className="relative min-h-screen overflow-x-clip" style={{ backgroundColor: "#161617" }}>
      ...
      <div
        ...
        style={{ top: 0, background: "linear-gradient(to top, rgba(22,22,23,0.2), #FFD8FE)", opacity: 0.5 }}
      />
      <HomeButton />
