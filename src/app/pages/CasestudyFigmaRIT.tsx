      ...
      >
        <div className="flex flex-col gap-[75px] items-center w-full">
          ...
          <div className="flex flex-col gap-[16px] items-center w-full">
            <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-none text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)] max-w-[65ch] w-full text-center">
              Our impact
            </p>
            <div className="font-['SF_Pro_Display',sans-serif] font-[450] leading-[1.2] font-medium text-[color:var(--text\/primary,#faf9ff)] text-[32px] md:text-[40px] max-w-[65ch] w-full text-center">
          ...
          <div id="cs-design" className="flex flex-col gap-[75px] items-start w-full">
            {/* Section header */}
            <div className="flex flex-col gap-[16px] items-start w-full">
              <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-none text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)] max-w-[65ch] w-full text-center">Wireframes</p>
              <p className="font-['SF_Pro_Display',sans-serif] font-medium leading-[1.2] text-[#faf9ff] text-[32px] md:text-[40px] max-w-[65ch] w-full">Sprinting to be ready for Figbuild on Super Bowl Sunday</p>
            </div>

            {/* The Flow */}
            <div className="flex flex-col gap-[32px] items-start w-full">
              <div className="flex flex-col gap-[16px] items-start w-full">
                <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-none text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)]">The Flow</p>
                <p className="font-['SF_Pro_Display',sans-serif] font-medium leading-[1.3] text-[#faf9ff] text-[length:var(--typography-body-default-font-size)] md:text-[24px] max-w-[65ch] w-full">
                  The flow was meant to be easy, and we narrowed our scope.
                </p>
                <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-[1.65] text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)] max-w-[65ch] w-full">
              ...
              <img src={imgUserflow} className="aspect-[3/2] rounded-[var(--radius-component-image)] w-full object-cover" alt="User flow" />
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-[24px] items-start w-full">
              <div className="flex flex-1 flex-col gap-[16px] items-start min-w-0">
                <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-none text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)]">Iterations</p>
                <p className="font-['SF_Pro_Display',sans-serif] font-medium leading-[1.3] text-[#faf9ff] text-[length:var(--typography-body-default-font-size)] md:text-[24px] max-w-[65ch] w-full">After the initial call, we built for just one flow.</p>
                <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-[1.65] text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)] max-w-[65ch] w-full">
            ...
            <div className="flex flex-col gap-[32px] items-start w-full">
              <div className="flex flex-col gap-[16px] items-start w-full">
                <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-none text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)]">Design Proposal</p>
                <p className="font-['SF_Pro_Display',sans-serif] font-medium leading-[1.3] text-[#faf9ff] text-[length:var(--typography-body-default-font-size)] md:text-[24px] max-w-[65ch] w-full">Finalizing wireframes and design proposal for branding</p>
                <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-[1.65] text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)] max-w-[65ch] w-full">
              ...
              <img src={imgDocumentation} className="aspect-[3/2] rounded-[var(--radius-component-image)] w-full object-cover" alt="Documentation" />
            </div>
            ...
            <div className="border border-[#302f34] flex flex-col gap-[75px] items-start pb-[32px] pt-[24px] px-[24px] rounded-[8px] w-full" style={{ background: "#161617" }}>
              ...
              <div className="flex flex-col gap-[24px] items-start pb-[42px] w-full">
                <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-none text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)]">Workflow</p>
                {/* Icons with glow */}
                ...
                <p className="font-['SF_Pro_Display',sans-serif] leading-[1.3] font-medium text-[#faf9ff] text-[length:var(--typography-body-default-font-size)] md:text-[24px] max-w-[65ch] w-full">
              ...
              <div className="flex gap-[24px] items-start w-full">
                <div className="flex flex-1 flex-col gap-[16px] items-start min-w-0">
                  <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-none text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)]">3 Days left...</p>
                  <p className="font-['SF_Pro_Display',sans-serif] leading-[1.3] font-medium text-[#faf9ff] text-[length:var(--typography-body-default-font-size)] md:text-[24px]">Lasya put our work into Figma Make</p>
              ...
              <div className="flex gap-[24px] items-start w-full">
                <div className="flex flex-1 flex-col gap-[16px] items-start min-w-0">
                  <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-none text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)]">2 Days left...</p>
                  <p className="font-['SF_Pro_Display',sans-serif] leading-[1.3] font-medium text-[#faf9ff] text-[length:var(--typography-body-default-font-size)] md:text-[24px]">We sprinted for 2 days and 2 nights making it all work.</p>
                  <p className="font-['SF_Pro_Display',sans-serif] font-regular leading-[1.65] text-[#908e99] text-[14px] md:text-[length:var(--typography-body-default-font-size)]">
          ...
          <div id="cs-review" className="flex flex-col gap-[24px] items-start w-full">
            ...
            {/* Point 1 */}
            <div className="border border-[#302f34] flex font-['SF_Pro_Display',sans-serif] gap-[16px] items-start mt-[16px] p-[16px] rounded-[8px] w-full" style={{ background: "rgba(88,85,100,0.3)" }}>
              ...
              <div className="flex flex-1 flex-col gap-[8px] items-start leading-[1.65] text-[14px] md:text-[length:var(--typography-body-default-font-size)] min-w-0">
                ...
                <p className="font-regular text-[#908e99] max-w-[65ch] w-full">
            ...
            {/* Point 2 */}
            <div className="border border-[#302f34] flex font-['SF_Pro_Display',sans-serif] gap-[16px] items-start p-[16px] rounded-[8px] w-full" style={{ background: "rgba(88,85,100,0.3)" }}>
            ...
            <div className="border border-[#302f34] flex font-['SF_Pro_Display',sans-serif] gap-[16px] items-start p-[16px] rounded-[8px] w-full" style={{ background: "rgba(88,85,100,0.3)" }}>
              ...
              <div className="flex flex-1 flex-col gap-[8px] items-start leading-[1.65] text-[14px] md:text-[length:var(--typography-body-default-font-size)] min-w-0">
                ...
                <p className="font-regular text-[#908e99] text-[12px] md:text-[14px] max-w-[65ch] w-full leading-[1.5]">
